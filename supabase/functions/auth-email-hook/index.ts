...
// Configuration
const SITE_NAME = "bringyourfive-hub-link"
const SENDER_DOMAIN = "notify.by5.run"
const ROOT_DOMAIN = "by5.run"
const FROM_DOMAIN = "notify.by5.run" // Domain shown in From address (may be root or sender subdomain)
...
const SAMPLE_PROJECT_URL = "https://bringyourfive-hub-link.lovable.app"
